...
namespace TaoBao.DAL
{
    public static class SQLhelper
    {
        ...
        private static string sqlStr = "data source=.;uid=buyiliuleishaonian;password=jgw5201314;database=tbdb";
        ...
        /// <param name="paras"></param>
        /// <returns></returns>
        public static DataTable DataTable(string str, params SqlParameter[] paras)
        {
            DataTable da = null;
            using (SqlConnection sqlcon = new SqlConnection(sqlStr))
            {
